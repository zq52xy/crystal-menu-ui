# Copyright and Publishing Boundary

## Working Assumption

This is a learning project. It may study public references, but published artifacts must be original and de-branded.

## Allowed

- Write notes about visual patterns.
...
- Official screenshots or cropped UI cuts.
...
Before public release, perform a human review for:
...
This document is not legal advice. It is a working boundary for a learning project.
