// [PROTOCOL]: Change this header when the public component index taxonomy changes, then check CLAUDE.md.
// INPUT: Implemented package component names plus bilingual SEO query clusters.
// OUTPUT: Demo-only bilingual component index metadata for searchable public catalog pages.
// POS: Demo content map; rendering lives in ComponentIndexPage.
export type ComponentIndexItem = {
  ...
  readonly useCaseZh: string;
  readonly aiPrompt: string;
  readonly aiPromptZh: string;
  readonly keywords: readonly string[];
};

export const componentIndexItems: readonly ComponentIndexItem[] = [
  {
    name: 'PartyMenuShell',
    ...
    keywords: ['React JRPG menu', 'RPG pause menu', '游戏菜单框架'],
  },
  {
    name: 'EquipmentPanel',
    category: 'Equipment',
    ...
    keywords: ['equipment screen', 'RPG gear UI', '装备界面'],
  },
  {
    ...
    keywords: ['materia UI', 'skill tree card', '魔晶石成长'],
  },
  {
    ...
    keywords: ['weapon matrix', 'SP upgrade UI', '武器升级矩阵'],
  },
  {
    name: 'BattleMenu',
    category: 'Combat',
    ...
    keywords: ['battle command UI', 'RPG combat menu', '战斗菜单'],
  },
  {
    name: 'LimitGauge',
    ...
    keywords: ['limit break gauge', 'special meter UI', '极限技计量条'],
  },
  {
    name: 'DamageNumber',
    category: 'Combat Feedback',
    ...
    keywords: ['damage number', 'combat feedback', '伤害数字'],
  },
  {
    ...
    keywords: ['chapter title UI', 'mission intro card', '章节标题卡'],
  },
  {
    name: 'ProfileScreen',
    category: 'Character',
    ...
    keywords: ['character sheet UI', 'party profile', '角色资料页'],
  },
  {
    name: 'SaveSlot',
    category: 'System',
    ...
    keywords: ['save slot UI', 'game archive row', '存档界面'],
  },
];

export const componentIndexStats = {
  components: 30,
  categories: 8,
  searchQueries: ['React JRPG UI kit', 'React 游戏 UI 组件库', 'Final Fantasy inspired UI', '最终幻想风格 UI', 'AI-ready game UI components'],
} as const;
